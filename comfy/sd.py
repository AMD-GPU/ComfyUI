...
def load_clip_with_T5Qat(ckpt_paths, t5_qat_sd_path, embedding_directory=None, clip_type=CLIPType.STABLE_DIFFUSION, model_options={}):
    clip_data = []
    for p in ckpt_paths:
        clip_data.append(comfy.utils.load_torch_file(p, safe_load=True))
    clip_data.append(t5_qat_sd_path)
